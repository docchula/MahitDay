export const REGISTRATION_STAGE = 'close';
...
export const ALLOW_CERTIFICATE_PRINTING = false; // true or false (REGISTRATION_STAGE should be 'open' before setting to 'true')
